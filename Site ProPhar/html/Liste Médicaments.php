                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Liste Médicaments</li>
                        </ol>
                    </div>
...
$req=mysqli_query($con,$sql);
  ...
  $r2="select  medicament.code_lot,id_medicament,num_pharm,DCI,nom_C,dosage,nom_form,nom_famille,Date_Fab,Date_Pre,Unite_de_Mesure,Qte_de_produit from medicament  join lot where medicament.code_lot=lot.code_lot and num_pharm ='".$_SESSION['num_pharm']."' ";
  $req2=mysqli_query($con,$r2);
      echo "<div class='row'>
                    ...
                    <div class='col-lg-12'>
                        <div class='card'>
                            <div class='card-block'>
                                <h1 style=' text-decoration:underline;color=#73A5F1;'>Liste des Médicaments</h1>
...
<!--
  ...
  echo "<table style='width:100%'><tr class='tbl'><td>Username</td><td>Nom</td><td>prénom</td><td>Password</td><td>login</td><td>Service</td><td>N_etage</td><td>Département</td><td>Modification</td></tr>";
