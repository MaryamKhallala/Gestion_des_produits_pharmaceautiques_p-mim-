...
<body class="fix-header fix-sidebar card-no-border">
                            ...
                            <div class="card-block">
                                <form class="form-horizontal form-material" method="POST" action="">
                                    <div class="form-group">
                                        <label class="col-md-12">Code_Lot</label>
                                        <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button  class="btn btn-success"name="update" style="margin-left: 500px">Ajouter</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
 ...
 <?php
       ...
       $_SESSION['Code_Lot']=$_POST['Code_Lot'];
       
        $db =mysqli_connect('localhost','root','','gestion_prophar');
       
        $req= "insert into lot values ('".$_POST['Code_Lot']."','".$_POST['Date_Fab']."','".$_POST['Date_Pre']."','".$_POST['Unite_de_Mesure']."','".$_POST['Qte_de_produit']."')";
        ...
        $query="INSERT INTO medicament VALUES ('".$_POST['Code_Lot']."','".$_POST['id_medicament']."','".$_POST['num_pharm']."','".$_POST['DCI']."','".$_POST['nom_C']."','".$_POST['dosage']."','".$_POST['nom_form']."','".$_POST['nom_famille']."')";
         if ($_POST['Date_Fab']<$_POST['Date_Pre']) {
        $result=mysqli_query($db,$query);
           
           if ($result==true) {
                
        echo "<script>alert('L ajout à été effectuer avec succée!!')</script>";
 
        $requ="insert into historique values ('medicament et lot',CURDATE(),'".$_SESSION['num_pharm']."','Ajouter','Null','".$_POST['Code_Lot']."')";
