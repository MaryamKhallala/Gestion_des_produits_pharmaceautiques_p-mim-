...
<head>
    ...
    <title>Historique de Modification</title>
    <!-- Bootstrap Core CSS -->
...
<body class="fix-header fix-sidebar card-no-border">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Historique de Modification</li>
                        </ol>
                    </div>
  ...
  $r2="select * from historique where utilisateur='".$_SESSION['num_pharm']."'";
                    ...
                    <div class='col-lg-12'>
                        <div class='card'>
                            <div class='card-block'>
                                <h1 style=' text-decoration:underline;color=#73A5F1;'>Historique de Modification</h1>
                               
                                <div class='table-responsive'>
                                    <table class='table'>
                                        <thead>
                                            <tr style='background-color=#BED6FA ;color:black;'>
                                                <th><strong>nom_table</strong></th>
                                                <th><strong>date_time</strong></th>
                                                <th><strong>utilisateur</strong></th>
                                                <th><strong>type_modification</strong></th>
                                                <th><strong>ancien_valeur</strong></th>
                                                <th><strong>nouvelle_valeur</strong></th>
                                        ...
                                        while($val2 = mysqli_fetch_row($req2)){
                                           ...
                                           echo"<tbody>
                                               <tr class='var'><td>".$val2['0']."</td><td>".$val2['1']."</td><td>".$val2['2']."</td><td>".$val2['3']."</td><td>".$val2['4']."</td><td>".$val2['5']."</td>
