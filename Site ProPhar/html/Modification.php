 ...
 ?>
                 ...
                 <div class="col-lg-8 col-xlg-9 col-md-7">
                        <div class="card">
                            <div class="card-block">
                                <form class="form-horizontal form-material" method="POST" action="Modification.php">
                                    <div class="form-group">
                                        <label class="col-md-12">Numéro pharmacien</label>
                                        <div class="col-md-12">
                                            <input type="text"  name="num_pharm"  class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-email" class="col-md-12"> Nom</label>
                                        <div class="col-md-12">
                                            <input type="text" name="nom_pharm"  class="form-control form-control-line" name="example-email" id="example-email">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Prénom</label>
                                        <div class="col-md-12">
                                            <input type="text" name="prenom_pharm"  class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Adress</label>
                                        <div class="col-md-12">
                                            <input type="text" name="adress_pharm"  class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Num Téléphone</label>
                                        <div class="col-md-12">
                                            <input type="text" name="tel_pharm"   class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Email</label>
                                        <div class="col-md-12">
                                            <input type="Email" name="email_pharm"  class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Mot de passe</label>
                                        <div class="col-md-12">
                                            <input type="password" name="passeword"  class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button  class="btn btn-success"name="update">Modifier</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
  ...
  <?php
       ...
       if (isset($_POST['update'])){
        ...
        $req="insert into historique values ('pharmacien',CURDATE(),'Pharmacien','Modification','Null','".$_POST['nom_pharm']."')";
